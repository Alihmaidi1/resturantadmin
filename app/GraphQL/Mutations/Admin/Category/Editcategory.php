...
final class Editcategory
{
    ...
    public function __invoke($_, array $args)
    {
        ...
        $status=$args["status"];
        $images = $args["images"];
        $category = $this->category->update($id, $name_en, $name_ar, $logo, $description_en, $description_ar, $meta_description_en, $meta_description_ar, $meta_title_en, $meta_title_ar, $meta_logo, $keywords, $status, $images);
        return $category;
