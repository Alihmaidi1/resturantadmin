...
return [
    ...
    "you don't have permmssion to Show Admin"=>"you don't have permmssion to Show Admin",
    "age should be integer"=>"age should be integer",
    "gender value should be 0 or 1"=>"gender value should be 0 or 1",
    "you don't have permmssion to create admin"=>"you don't have permmssion to create admin",
    "age should be integer"=>"age should be integer",
