...
return [
    ...
    "you don't have permmssion to Show Admin"=>"انت لا تملك صلاحيات عرض الادمن",
    "age should be integer"=>"العمر يجب أن يكون من النوع صحيح",
    "gender value should be 0 or 1"=>"قيم نوع الجنس يجب أن تكون أما 0 أو 1",
    "you don't have permmssion to create admin"=>"أنت لا تملك الصلاحيات لانشاء أدمن",
    "age should be integer"=>"العمر يجب أن يكون عدد صحيح",
